...
export const HERO_CARD = {
  short:    { label: 'Best Short-Dated',           icon: '⚡', emptyLabel: 'No qualifying short-dated option found this session'    },
  long:     { label: 'Best Long-Dated / LEAP',     icon: '🚀', emptyLabel: 'No qualifying long-dated option or LEAP found this session' },
  moonshot: { label: 'Top Moonshot — return only', icon: '🎰', emptyLabel: 'No qualifying moonshot found this session'               },
  stats: {
