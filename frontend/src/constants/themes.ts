  ...
  },
  {
    ...
    judgementCalls: {
      ...
      rules: [
        ...
        { rule: 'Out-of-the-money puts only', detail: 'We want downside optionality, not intrinsic value. ITM puts are excluded.' },
        ...
        { rule: 'Scored by return × prob ITM', detail: 'Puts ranked by return multiple times Black-Scholes probability ITM.' },
        { rule: 'Top 10 per bucket',          detail: 'Short-dated and long-dated buckets capped at 10 each. Moonshots surfaced separately.' },
      ],
    },
  },
  {
    ...
    judgementCalls: {
      ...
      rules: [
        ...
        { rule: 'Out-of-the-money puts only', detail: 'We want optionality on a re-rating event, not intrinsic value. ITM puts are excluded.' },
  ...
  },
  {
    ...
    judgementCalls: {
      ...
      rules: [
        ...
        { rule: 'Out-of-the-money calls only', detail: 'We want continuation optionality, not intrinsic value. ITM calls are excluded.' },
        ...
        { rule: 'Minimum liquidity',          detail: 'Open interest ≥ 10, or any volume traded today, or a recorded last price.' },
        { rule: 'Scored by return × prob ITM', detail: 'Calls ranked by return multiple times Black-Scholes probability ITM.' },
        { rule: 'Top 10 per bucket',          detail: 'Short-dated and long-dated buckets capped at 10 each. Moonshots surfaced separately.' },
      ],
    },
  },
  {
    ...
    judgementCalls: {
      ...
      rules: [
        ...
        { rule: 'Out-of-the-money calls only', detail: 'We want asymmetric upside on the squeeze leg, not intrinsic value. ITM calls are excluded.' },
