...
export default function HomePage({ onNavigate }: Props) {
  ...
  const [callsThemeId, setCallsThemeId] = useSessionTheme('calls')
  const [putsThemeId,  setPutsThemeId]  = useSessionTheme('puts')
  ...
  const callsCards: DeckCard[] = callsReport ? [
    { option: callsReport.heroes.short,    movePct: callsReport.heroes.short?.move_pct    ?? 0, moveLabel: callsReport.heroes.short?.move_label    ?? '', label: HERO_CARD.short.label,    icon: HERO_CARD.short.icon,    emptyLabel: HERO_CARD.short.emptyLabel,    heroRowId: 'hero-call-short'    },
    { option: callsReport.heroes.long,     movePct: callsReport.heroes.long?.move_pct     ?? 0, moveLabel: callsReport.heroes.long?.move_label     ?? '', label: HERO_CARD.long.label,     icon: HERO_CARD.long.icon,     emptyLabel: HERO_CARD.long.emptyLabel,     heroRowId: 'hero-call-long'     },
    { option: callsReport.heroes.moonshot, movePct: callsReport.heroes.moonshot?.move_pct ?? 0, moveLabel: callsReport.heroes.moonshot?.move_label ?? '', label: HERO_CARD.moonshot.label, icon: HERO_CARD.moonshot.icon, emptyLabel: HERO_CARD.moonshot.emptyLabel, heroRowId: 'hero-call-moonshot' },
  ] : []

  const putsCards: DeckCard[] = putsReport ? [
    { option: putsReport.heroes.short,    movePct: putsReport.heroes.short?.move_pct    ?? 0, moveLabel: putsReport.heroes.short?.move_label    ?? '', label: HERO_CARD.short.label,    icon: HERO_CARD.short.icon,    emptyLabel: HERO_CARD.short.emptyLabel,    heroRowId: 'hero-short'    },
    { option: putsReport.heroes.long,     movePct: putsReport.heroes.long?.move_pct     ?? 0, moveLabel: putsReport.heroes.long?.move_label     ?? '', label: HERO_CARD.long.label,     icon: HERO_CARD.long.icon,     emptyLabel: HERO_CARD.long.emptyLabel,     heroRowId: 'hero-long'     },
    { option: putsReport.heroes.moonshot, movePct: putsReport.heroes.moonshot?.move_pct ?? 0, moveLabel: putsReport.heroes.moonshot?.move_label ?? '', label: HERO_CARD.moonshot.label, icon: HERO_CARD.moonshot.icon, emptyLabel: HERO_CARD.moonshot.emptyLabel, heroRowId: 'hero-moonshot' },
  ] : []
