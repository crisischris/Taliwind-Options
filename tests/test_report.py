...
# Convenience wrappers to keep test names self-documenting
def _put_to_dict(s, with_context=False):
    return _option_to_dict(s, is_put=True, with_context=with_context)

def _call_to_dict(s, with_context=False):
    return _option_to_dict(s, is_put=False, with_context=with_context)
