...
_INVOKE_TIMEOUT_SECS = 620  # Lambda timeout is 10 min; leave 20 s headroom
...
@pytest.fixture(scope="session")
def lambda_client():
    return boto3.client("lambda", region_name=REGION, config=Config(read_timeout=_INVOKE_TIMEOUT_SECS))
